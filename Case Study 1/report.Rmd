...
Alguns testes não foram feitos pois a amostra não tem uma representação normal associada. Já outros testes pelo fato de se ter somente uma amostra. Sugere-se possibilidade de extrair mais amostras na nova versão do software, a fim de comparar com a versão atual. De posse de mais amostras é possível utilizar de outros testes para calcular os estimadores de interesse, na possibilidade até de se evitar o uso da ferramenta de reamostragem, como foi usada no experimento acima.
