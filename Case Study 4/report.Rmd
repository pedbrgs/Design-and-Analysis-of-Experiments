...
Ao comparar dois algoritmos, espera-se que um tenha melhor solução que o outro, foi o idealizado ao elaborar a hipótese nula do estudo. A principio, graficamente, a diferença era pouco aparente, de qualquer forma, o estudo estatístico faz-se necessário entre outras aplicações, definir com certo nível de confiança, se esta diferença existe e qual tem melhor desempenho.
Sendo assim, após os estudos aqui mostrados, através da analise das variâncias conclui-se que com $95\%$ de confiança que existe diferença estatística entre as soluções dos algoritmos e que também com $95\%$ de confiança, através do teste de comparações múltiplas, que o $Algoritmo 2$ apresenta melhor solução perante o $Algoritmo 1$. Uma vez estatísticamente comprovado que o $Algoritmo 2$ tem melhor solução que o $Algoritmo 1$, pode-se corroborar com $95\%$ de confiança com a hipótese nula $H0$ principal do estudo, de que o $Algoritmo 1$ teria media maior ou igual ao $Algoritmo 2$, mais uma vez, aquele que tem menor média apresenta melhor solução.
