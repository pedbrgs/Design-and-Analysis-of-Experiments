...
Pela analise do p valor, tem-se a mesma conclusão, visto que os intervalos dos rendimentos das ações ($X3$ e $X1$) e ($X4$ e $X2$) retornou p valor maior que $0,05$. Os demais p valores são menores que o nível de significância igual a $0,05$, enfatizando que têm rendimentos são significativamente diferentes.
