...
```
No experimento em questão, o p valor retornado foi $p = 2 \times 10^{-16}$, o que significa que com 95% de confiança, a hipótese nula de que as medias dos rendimentos são iguais, é rejeitada. Ou seja, foram detectadas diferenças significativas entre as medias dos rendimentos das ações em estudo.
